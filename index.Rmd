...
3. While strict mandates don’t correspond to better health outcomes, there is strong evidence that teachers’ buy-in to the material do correspond to better health outcomes. In particular, there seems to be a strong effect of teacher practices regarding STD and HIV prevention in decreasing STD and HIV rates (though we cannot assume this is a causal relationship.)  

On the other hand, schools that provide sex ed teachers the materials they need, going beyond state mandate guidelines, have not seen the reward of better student health outcomes. 
