...
<iframe height="750" width="100%" frameborder="no" title="Histogram1" src="https://anayak23.shinyapps.io/Blog_L1/"> </iframe>
...
<iframe height="750" width="100%" frameborder="no" title="ScatterEdu" src="https://anayak23.shinyapps.io/edu_scatter/"> </iframe>
...
<iframe height="850" width="100%" frameborder="no" title="Histogram3" src="https://anayak23.shinyapps.io/Blog_L3/ "> </iframe>
...
|---------------|:-------------:|:-------------:|
| Medically Accurate | Births per 1k Girls | This map reveals both the underlying regional variations in Births per 1k Girls, as well as some correlations between the medically accurate mandate with NC and VA showing relatively low numbers of births in the context of their region. We also see an incredibly mixed bag in terms of the states that do and do not mandate medically accurate sexual education. |
| Sex Ed Abstinence | Births per 1k  | This mandate is an interesting one, especially in the context that abstinence only sex ed has largely been shown to do little to stop teens from having sex. As can be seen, the majority of states have this mandate, with a particular regional focus in the south. It should also be noted that the new england states with the lowest birth rate among girls all only mandate coverage, but not a stress on absitence. Similarly, the states with the highest birth rates among girls, in the south, all mandate a stress on abstience.|
